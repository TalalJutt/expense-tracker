...
//import { collection, getDocs } from "firestore/lite";
        ...
        <div className='py-5 w-100'>
            <div className='container'>
                <div className='row'>
                    ...
                    :<div className='text-center'><div className="spinner-border text-white" as="td"></div></div>
}    
                       </div>
                        </div>
                        </div>
  ...
  <div className="modal-dialog-centered">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-5">Edit {productForEdit.title}</h1>
      ...
      <div class="modal-body">
        <div className="row mb-3">
              ...
              <div className="row mb-3">
                <div className="col">
                  <input type="number" className="form-control" placeholder="Description" name="description" value={productForEdit.description} onChange={handleChange}/>
                </div>
                </div>
               < div className="row mb-3">
                <div className="col">
                  <input type="text" className="form-control" placeholder="Price" name="price" value={productForEdit.price} onChange={handleChange}/>
                </div>
                </div>
