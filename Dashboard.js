                        ...
                        <div className='col-12 col-md-4'>
                            <div className='card h-100 text-center p-4'>
                                <div className='card-body'>
                                    ...
                                    <h2 className='text-white display-6 fw-bold'>${metrics.totalExpense.toLocaleString()}</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='col-12 col-md-4'>
                            <div className='card h-100 text-center p-4'>
                                <div className='card-body'>
                                    ...
                                    <h2 className='text-white display-6 fw-bold'>${metrics.averageExpense}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='col-12 col-lg-8 offset-lg-2'>
                            <div className='card p-4'>
                                ...
                                <p className='text-white-50 small mb-0'>
                                    Your current tracking system is monitoring <strong>{metrics.totalCount}</strong> items with a total value of <strong>${metrics.totalExpense.toLocaleString()}</strong>. Keep managing your products to stay on top of your budget.
                                </p>
                            </div>
                        </div>
                    </div>
